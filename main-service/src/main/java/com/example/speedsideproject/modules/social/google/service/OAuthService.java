package com.example.speedsideproject.modules.social.google.service;
...
import com.example.speedsideproject.domain.account.repository.RefreshTokenRepository;
...
import com.example.speedsideproject.modules.social.google.GoogleOauth;
import com.example.speedsideproject.modules.social.google.dto.GoogleOAuthToken;
import com.example.speedsideproject.modules.social.google.dto.GoogleUser;
import com.example.speedsideproject.global.security.jwt.dto.TokenDto;
import com.example.speedsideproject.global.security.jwt.util.JwtUtil;
...
public class OAuthService {
    ...
    public void request(GoogleUser.SocialLoginType socialLoginType) throws IOException {
        String redirectURL;
    ...
    public TokenDto oAuthLogin(GoogleUser.SocialLoginType socialLoginType, String code) throws IOException {
        switch (socialLoginType) {
            case GOOGLE: {
