package com.example.speedsideproject.domain.post.controller;
...
import com.example.speedsideproject.domain.post.service.PostService;
...
public class PostController {
    ...
    //모든 글 읽어 오기
    @ApiOperation(value = "전체 게시글 조회", notes = "예시 page,size,sort기능 [main-service/posts/all?page=0&size=3&sort=postId,DESC]")
    @GetMapping("/all")
    ...
    /*v8 카테고리별 읽어오기*/
    @ApiOperation(value = "전체 게시글 + 카테고리별 게시글 조회", notes = "예시 page,size,sort기능 [main-service/posts/v8/all?page=0&size=3&sort=postId,DESC]")
    @GetMapping("/v8/all")
...
//        log.info("place: {}", place);
   ...
   //글 1개 읽기
    ...
    //v2 글 1개 읽기
    @ApiOperation(value = "게시글 조회 v2", notes = "BD에 저장된 하나의 게시글을 조회합니다. 최적화 버전")
    @GetMapping("/{id}")
