package com.example.speedsideproject.domain.account.controller;


import com.example.speedsideproject.domain.account.dto.AccountReqDto;
import com.example.speedsideproject.domain.account.dto.EmailRequestDto;
...
import com.example.speedsideproject.domain.account.service.AccountService;
...
//    }
    ...
    /*이메일 중복체크*/
    @ApiOperation(value = "이메일 중복 체크 ", notes = "email조건 : x, pw조건 : x")
    @PostMapping("/email")
